...
HD_PWD='C:/Users/Malwi/Dropbox/PROGR/fpga/Kalkulator/Kalkulator/Kalkulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kalkulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kalkulator.tcl
