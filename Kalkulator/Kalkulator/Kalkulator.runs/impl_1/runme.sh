...
HD_PWD='C:/Users/Malwi/Dropbox/PROGR/fpga/Kalkulator/Kalkulator/Kalkulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kalkulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kalkulator.tcl -notrace
